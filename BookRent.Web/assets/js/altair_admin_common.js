...
// 3. Common functions & variables
    ...
    altair_forms = {
        ...
        textarea_autosize: function(parent) {
            $textarea = parent ? $(parent).find('textarea.md-input').not('.no_autosize') : $('textarea.md-input').not('.no_autosize');
        ...
        select_elements: function(parent) {
            ...
            var $selectize = parent ? $(parent).find('[data-md-selectize],.data-md-selectize') : $("[data-md-selectize],.data-md-selectize");
            ...
            // dropdowns
            var $selectize_inline = parent ? $(parent).find('[data-md-selectize-inline]') : $("[data-md-selectize-inline]");
        ...
        dynamic_fields: function() {
            // clone section
            $('#page_content').on('click', '.btnSectionClone', function(e) {
                e.preventDefault();
                var $this = $(this),
                ...
                altair_md.checkbox_radio($newSection);
    ...
    altair_main_sidebar = {
        ...
        mini_sidebar: function() {
            ...
            $sidebar_main.find('.menu_section > ul > li > a > button').hide();
    ...
    altair_md = {
        ...
        card_fullscreen: function() {
            //var $cards = $('.md-card-fullscreen-activate');
            //$cards.on('click',function() {
            $page_content.on('click', '.md-card-fullscreen-activate',function(){
        ...
        checkbox_radio: function(parent) {
            var mdCheckbox = parent ? $(parent).find('[data-md-icheck],.data-md-icheck') : $('[data-md-icheck],.data-md-icheck');
